                      ...
                      <div class="card-body card-block">
                        <!-- <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="name_order" name="name_order" class="form-control" value="{{ $order->name_order }}" ></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Address</label></div>
                            <div class="col-12 col-md-9"><textarea name="address_order" id="address_order" rows="4" class="form-control">{{ $order->address_order }}</textarea></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Benchmark</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="mark_order" name="mark_order" class="form-control" value="{{ $order->mark_order }}"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Telephone</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="telp_order" name="telp_order" class="form-control" value="{{ $order->telp_order }}"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Email</label></div>
                            <div class="col-12 col-md-9"><input type="email" id="email_order" name="email_order" class="form-control" value="{{ $order->email_order }}"></div>
                          </div>
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <select name="pack_order" id="pack_order" class="form-control" >
                                <option value="{{ $order->pack_order }}">{{ $order->pack_order }}</option>
                            ...
                            <div class="col-12 col-md-9">
                                <div class="col-4 p-0">
                                    <select name="odpzone_order" id="odpzone_order" class="form-control">
                                        <option value="{{ $order->odpzone_order }}">{{ $order->odpzone_order }}</option>
                                ...
                                <div class="col-3 p-0"><input type="text" id="odp_order" name="odp_order" class="form-control" value="{{ $order->odp_order }}"></div>
                                <div class="col-1 p-0 text-center">-</div>
                                <div class="col-3 p-0"><input type="text" id="odpnum_order" name="odpnum_order" class="form-control" value="{{ $order->odpnum_order }}"></div>
                            </div>
                          </div>
